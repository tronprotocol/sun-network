...
public class TriggerConstant013 {
  ...
  public void test01TriggerContract() {
    ...
    AccountResourceMessage resourceInfoafter1 = PublicMethedForDailybuild.getAccountResource(contractExcAddress,
        blockingStubFull);
  ...
  public void test15TriggerConstantContract() {
    ...
    SmartContract smartContract = PublicMethedForDailybuild.getContract(returnAddressBytes, blockingStubFull);
