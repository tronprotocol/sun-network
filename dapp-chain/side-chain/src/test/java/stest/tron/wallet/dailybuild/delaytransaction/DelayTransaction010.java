...
public class DelayTransaction010 {
  ...
  public void test1TestDelayedTransactionFee() {
    ...
    Assert.assertTrue(
        PublicMethedForDailybuild.sendcoin(delayFeeAccountAddress, 100000000L, fromAddress,
            testKey002, blockingStubFull));
    PublicMethedForDailybuild.waitProduceNextBlock(blockingStubFull);
    final String txidZeroDay = PublicMethedForDailybuild
        .sendcoinDelayedGetTxid(delayAccount2Address, 1L,
    ...
    final String txidOneDay = PublicMethedForDailybuild
        .sendcoinDelayedGetTxid(delayAccount2Address, 1L,
            ONE_DELAY_SECONDS - 1, delayFeeAccountAddress, delayFeeAccountKey, blockingStubFull);
    final String txidTwoDay = PublicMethedForDailybuild
        .sendcoinDelayedGetTxid(delayAccount2Address, 1L,
            ONE_DELAY_SECONDS * 2 - 1, delayFeeAccountAddress, delayFeeAccountKey,
            blockingStubFull);
    final String txidFiveDay = PublicMethedForDailybuild
        .sendcoinDelayedGetTxid(delayAccount2Address, 1L,
            ONE_DELAY_SECONDS * 6 - 1, delayFeeAccountAddress, delayFeeAccountKey,
            blockingStubFull);
    final String txidTenDay = PublicMethedForDailybuild
        .sendcoinDelayedGetTxid(delayAccount2Address, 1L,
            ONE_DELAY_SECONDS * 9, delayFeeAccountAddress, delayFeeAccountKey, blockingStubFull);
    final String txid45Day = PublicMethedForDailybuild
        .sendcoinDelayedGetTxid(delayAccount2Address, 1L,
            ONE_DELAY_SECONDS * 45, delayFeeAccountAddress, delayFeeAccountKey, blockingStubFull);
    final String txid28Day = PublicMethedForDailybuild
        .sendcoinDelayedGetTxid(delayAccount2Address, 1L,
    ...
    PublicMethedForDailybuild.waitProduceNextBlock(blockingStubFull);
    Assert
        .assertTrue(PublicMethedForDailybuild.getTransactionInfoById(txidZeroDay, blockingStubFull)
    ...
    Assert
        .assertTrue(PublicMethedForDailybuild.getTransactionInfoById(txidFiveDay, blockingStubFull)
  ...
  public void test2DelaydTransactionFinallyFailed() {
    ...
    Long beforeBalance = PublicMethedForDailybuild
        .queryAccount(delayFeeAccountAddress, blockingStubFull)
        .getBalance();
    final String preTxid = PublicMethedForDailybuild
        .sendcoinDelayedGetTxid(delayAccount2Address, sendAmount,
    ...
    Assert.assertTrue(
        PublicMethedForDailybuild.sendcoin(fromAddress, PublicMethedForDailybuild.queryAccount(
    ...
    Long beforeSendCoinAccount2Balance = PublicMethedForDailybuild
        .queryAccount(delayAccount2Address,
            blockingStubFull).getBalance();
  ...
  public void test3DelaydTransactionFinallySuccessfully() {
    Assert.assertTrue(
        PublicMethedForDailybuild.sendcoin(delayFeeAccountAddress, 10000000L, fromAddress,
            testKey002, blockingStubFull));
    PublicMethedForDailybuild.waitProduceNextBlock(blockingStubFull);
