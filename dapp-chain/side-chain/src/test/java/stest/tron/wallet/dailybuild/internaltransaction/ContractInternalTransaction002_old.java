...
public class ContractInternalTransaction002_old {
  ...
  public void test1InternalTransaction007() {
    ...
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    String filePath = "src/test/resources/soliditycode/contractInternalTransaction002test1InternalTransaction007.sol";
  ...
  public void test2InternalTransaction008() {
    ...
    String filePath = "src/test/resources/soliditycode/contractInternalTransaction002test2InternalTransaction008.sol";
    String contractName = "A";
    HashMap retMap = PublicMethed.getBycodeAbi(filePath, contractName);
    String code = retMap.get("byteCode").toString();
    String abi = retMap.get("abI").toString();
  ...
  public void test3InternalTransaction009() {
    Assert.assertTrue(PublicMethed
        .sendcoin(internalTxsAddress, 100000000000L, testNetAccountAddress, testNetAccountKey,
            blockingStubFull));
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    String filePath = "src/test/resources/soliditycode/contractInternalTransaction002test3InternalTransaction009.sol";
    String contractName = "A";
    HashMap retMap = PublicMethed.getBycodeAbi(filePath, contractName);
    String code = retMap.get("byteCode").toString();
    String abi = retMap.get("abI").toString();
  ...
  public void test4InternalTransaction010() {
    Assert.assertTrue(PublicMethed
        .sendcoin(internalTxsAddress, 100000000000L, testNetAccountAddress, testNetAccountKey,
            blockingStubFull));
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    String filePath = "src/test/resources/soliditycode_v0.4.25/contractInternalTransaction002test4InternalTransaction010.sol";
    String contractName = "A";
    HashMap retMap = PublicMethed.getBycodeAbi(filePath, contractName);
    String code = retMap.get("byteCode").toString();
    String abi = retMap.get("abI").toString();
    ...
    int transactionsCount1 = infoById1.get().getInternalTransactionsCount();
    Assert.assertEquals(78, transactionsCount1);
    dupInternalTrsansactionHash(infoById1.get().getInternalTransactionsList());
  ...
  public void test5InternalTransaction012() {
    ...
    String filePath = "src/test/resources/soliditycode_v0.4.25/contractInternalTransaction002test5InternalTransaction012.sol";
    String contractName = "A";
    HashMap retMap = PublicMethed.getBycodeAbi(filePath, contractName);
    String code = retMap.get("byteCode").toString();
    String abi = retMap.get("abI").toString();
