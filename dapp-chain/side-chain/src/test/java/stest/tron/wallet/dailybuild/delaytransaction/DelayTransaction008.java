...
public class DelayTransaction008 {
  ...
  public void test1DelayAccountUpdate() {
    ...
    Assert.assertTrue(
        PublicMethedForDailybuild.sendcoin(doUpdateAccountAddress, 1000000L, fromAddress,
            testKey002, blockingStubFull));

    final Long beforeUpdateAccountBalance = PublicMethedForDailybuild
        .queryAccount(doUpdateAccountKey,
    ...
    Long balanceInDelay = PublicMethedForDailybuild
        .queryAccount(doUpdateAccountKey, blockingStubFull)
        .getBalance();
    ...
    accountName = new String(
        PublicMethedForDailybuild.queryAccount(doUpdateAccountKey, blockingStubFull)
  ...
  public void test2CancelDelayUpdateAccount() {
    ...
    Assert.assertFalse(
        PublicMethedForDailybuild.cancelDeferredTransactionById(txid, doUpdateAccountAddress,
