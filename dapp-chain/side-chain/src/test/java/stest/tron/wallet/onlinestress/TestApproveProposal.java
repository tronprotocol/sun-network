...
//    Assert.assertTrue(PublicMethedForDailybuild.sideChainCreateProposal(witness001Address, witnessKey001,mainGateWayAddress,
...
//      witnessAddress = PublicMethedForDailybuild.getFinalAddress(key);
//      PublicMethed.approveSideProposal(witnessAddress, key,PublicMethed.getMaingatewayAddr(), proposalId,
