...
public class Create2Test018 {
  ...
  private byte[] witnessAddress001 = PublicMethedForDailybuild.getFinalAddress(witnessKey001);
  ...
  public void beforeClass() {
    ...
    PublicMethedForDailybuild.printAddress(witnessKey001);
  }
  ...
  public void test01DeployFactoryContract() {
    ...
    Assert.assertTrue(PublicMethedForDailybuild.sendcoin(witnessAddress001, 100_000_000L, fromAddress,
        testKey002, blockingStubFull));
  ...
  public void test02TriggerCreate2ToDeployTestContract() {
    Assert.assertTrue(PublicMethedForDailybuild.freezeBalanceForReceiver(fromAddress, 9000_000_000_000L, 0, 1,
    ...
    accountResource = PublicMethedForDailybuild.getAccountResource(witnessAddress001, blockingStubFull);
    long userEnergyLimitBefore = accountResource.getEnergyLimit();
    long userEnergyUsageBefore = accountResource.getEnergyUsed();
    long userBalanceBefore = PublicMethedForDailybuild.queryAccount(witnessAddress001, blockingStubFull)
        .getBalance();
    ...
    long userBalanceAfter = PublicMethedForDailybuild.queryAccount(witnessAddress001, blockingStubFull)
        .getBalance();
  ...
  public void test03TriggerTestContract() {
    ...
    Assert.assertTrue(PublicMethedForDailybuild.freezeBalanceForReceiver(fromAddress,
        PublicMethedForDailybuild.getFreezeBalanceCount(witnessAddress001, witnessKey001, 50000L,
            blockingStubFull), 0, 1,
        ByteString.copyFrom(witnessAddress001), testKey002, blockingStubFull));
