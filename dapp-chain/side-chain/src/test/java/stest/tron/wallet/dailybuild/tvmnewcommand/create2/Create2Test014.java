...
public class Create2Test014 {
  ...
  public void test03TriggerCreate2ToDeployTestContract() {
    ...
    SmartContract smartContract = PublicMethedForDailybuild.getContract(testContractAddress2, blockingStubFull);
  ...
  public void test04TriggerTest1Contract() {
    ...
    final String triggerTxid = PublicMethedForDailybuild.triggerContract(testContractAddress,
  ...
  public void test05TriggerTest2Contract() {
    ...
    final String triggerTxid = PublicMethedForDailybuild.triggerContract(testContractAddress2,
        "plusOne()", "#", false, callValue,
        1000000000L, "0", 0, user001Address, user001Key,
        blockingStubFull);
    PublicMethedForDailybuild.waitProduceNextBlock(blockingStubFull);
