...
//    Assert.assertEquals(0, byId2.get().);
  ...
  public void test1DepositTrc20002() {
    ...
    //deposit trc20 : address dont has trc20 coin
    String deposittrx = PublicMethed
        .depositTrc20(WalletClient.encode58Check(trc20Contract), mainChainAddress, 100, 1000000000,
    ...
    //deposit trc20 : address has trc20 coin
  ...
  @Test(enabled = true, description = "Deposit Trc20 Error condition with Executor ")
  /**
   * constructor.
   */
  @AfterClass
