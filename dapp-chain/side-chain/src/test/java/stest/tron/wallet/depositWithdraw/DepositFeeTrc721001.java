...
//    PublicMethed.printAddress(depositKey001);
  ...
  public void test1DepositTrc20001() {
    ...
    deposittrx = PublicMethed
        .depositTrc721ForDepositFee(WalletClient.encode58Check(trc20Contract), mainChainAddress,
            1001, 0,
            1000000000,
            testAddress001, testKey001, blockingStubFull);
    logger.info(deposittrx);
    ...
    Account accountMainAfter = PublicMethed.queryAccount(testAddress001, blockingStubFull);
    ...
    Assert.assertNotNull(deposittrx);
    Assert.assertEquals(0, infoById.get().getResultValue());
    Account accountMainAfter1 = PublicMethed.queryAccount(testAddress001, blockingStubFull);
