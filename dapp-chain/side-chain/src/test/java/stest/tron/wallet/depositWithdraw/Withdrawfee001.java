...
//value<fee
        String withdrawTrc20Txid = PublicMethed.withdrawtrc20fee(ChainIdAddress,
                ...
                maxFeeLimit, depositAddress,100,testKeyFordeposit, blockingStubFull, blockingSideStubFull);
...
//logger.info(("ss:"+response5.getMessage().toStringUtf8()));
        ...
        long bonsbrfore=ByteArray.toLong(response5.getConstantResult(0).toByteArray());
        logger.info("bonsbrfore:" + bonsbrfore);

        // value=fee
        String withdrawTrc20Txid1 = PublicMethed.withdrawtrc20fee(ChainIdAddress,
                sideChainAddress, "200",
                WalletClient.encode58Check(sideContractAddress),
                maxFeeLimit, depositAddress,200,testKeyFordeposit, blockingStubFull, blockingSideStubFull);
        ...
        TransactionExtention response6 = PublicMethed
                .triggerContractForTransactionExtention(WalletClient.decodeFromBase58Check(sideGatewayAddress),
                        0,input14,
                        maxFeeLimit, 0, "0", sideGateWayOwnerAddress, sideGateWayOwner, blockingSideStubFull);
        Assert.assertEquals(bonsbrfore+200,ByteArray.toLong(response6.getConstantResult(0).toByteArray()));
        ...
        String withdrawTrc20Txid2 = PublicMethed.withdrawtrc20fee(ChainIdAddress,
                sideChainAddress, "200",
                WalletClient.encode58Check(sideContractAddress),
                maxFeeLimit, depositAddress, 300,testKeyFordeposit, blockingStubFull, blockingSideStubFull);
