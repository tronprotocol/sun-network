...
public class DelayTransaction011 {
  ...
  public void test1BandwidthInDelayTransaction() {
    ...
    Assert.assertTrue(
        PublicMethedForDailybuild.sendcoin(noBandwidthAddress, 10000000000L, fromAddress,
            testKey002, blockingStubFull));
    PublicMethedForDailybuild.waitProduceNextBlock(blockingStubFull);
    while (PublicMethedForDailybuild.queryAccount(noBandwidthAddress, blockingStubFull)
        .getFreeNetUsage()
        < 4700L) {
      PublicMethedForDailybuild
          .sendcoin(delayAccount2Address, 1L, noBandwidthAddress, noBandwidthKey,
              blockingStubFull);
    }
    ...
    String txid = PublicMethedForDailybuild
        .updateAccountDelayGetTxid(noBandwidthAddress, accountNameBytes,
    ...
    Assert.assertTrue(
        PublicMethedForDailybuild.sendcoin(noBandwidthAddress, 103332L - 550L, fromAddress,
            testKey002, blockingStubFull));
    PublicMethedForDailybuild.waitProduceNextBlock(blockingStubFull);
