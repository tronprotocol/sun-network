...
public class ContractInternalTransaction003_old {
  ...
  public void testInternalTransaction013() {
    ...
    Assert.assertTrue(PublicMethed
        .sendcoin(internalTxsAddress, 100000000000L, testNetAccountAddress, testNetAccountKey,
            blockingStubFull));
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    String filePath = "src/test/resources/soliditycode_v0.4.25/contractInternalTransaction003testInternalTransaction013.sol";
  ...
  public void testInternalTransaction014() {
    Assert.assertTrue(PublicMethed
        .sendcoin(internalTxsAddress, 100000000000L, testNetAccountAddress, testNetAccountKey,
            blockingStubFull));
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    String filePath = "src/test/resources/soliditycode/contractInternalTransaction003testInternalTransaction014.sol";
    ...
    String txid3 = "";
    txid3 = PublicMethed.triggerContractSideChain(contractAddress,
  ...
  public void testInternalTransaction015() {
    Assert.assertTrue(PublicMethed
        .sendcoin(internalTxsAddress, 100000000000L, testNetAccountAddress, testNetAccountKey,
            blockingStubFull));
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    String filePath = "src/test/resources/soliditycode_v0.4.25/contractInternalTransaction003testInternalTransaction015.sol";
    String contractName = "A";
    HashMap retMap = PublicMethed.getBycodeAbi(filePath, contractName);
    String code = retMap.get("byteCode").toString();
    String abi = retMap.get("abI").toString();
  ...
  public void testInternalTransaction016() {
    Assert.assertTrue(PublicMethed
        .sendcoin(internalTxsAddress, 100000000000L, testNetAccountAddress, testNetAccountKey,
            blockingStubFull));
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    String filePath = "src/test/resources/soliditycode/contractInternalTransaction003testInternalTransaction016.sol";
    String contractName = "A";
    HashMap retMap = PublicMethed.getBycodeAbi(filePath, contractName);
    String code = retMap.get("byteCode").toString();
    String abi = retMap.get("abI").toString();
    ...
    Assert.assertEquals(71, transactionsCount1);
  ...
  public void testInternalTransaction017() {
    Assert.assertTrue(PublicMethed
        .sendcoin(internalTxsAddress, 100000000000L, testNetAccountAddress, testNetAccountKey,
            blockingStubFull));
    PublicMethed.waitProduceNextBlock(blockingStubFull);
    String filePath = "src/test/resources/soliditycode/contractInternalTransaction003testInternalTransaction017.sol";
    String contractName = "A";
    HashMap retMap = PublicMethed.getBycodeAbi(filePath, contractName);
    String code = retMap.get("byteCode").toString();
    String abi = retMap.get("abI").toString();
    ...
    Assert.assertTrue(infoById.get().getResultValue() == 0);
    int transactionsCount = infoById.get().getInternalTransactionsCount();
    Assert.assertEquals(72, transactionsCount);
    for (int i = 0; i < transactionsCount; i++) {
      Assert.assertFalse(infoById.get().getInternalTransactions(i).getRejected());
    }
    Assert.assertEquals("suicide", ByteArray
        .toStr(infoById.get().getInternalTransactions(71).getNote().toByteArray()));
    Assert.assertEquals(1000000 - 71,
        infoById.get().getInternalTransactions(71).getCallValueInfo(0).getCallValue());
  ...
  public void testInternalTransaction018() {
    ...
    String filePath = "src/test/resources/soliditycode/contractInternalTransaction003testInternalTransaction018.sol";
    String contractName = "A";
    HashMap retMap = PublicMethed.getBycodeAbi(filePath, contractName);
