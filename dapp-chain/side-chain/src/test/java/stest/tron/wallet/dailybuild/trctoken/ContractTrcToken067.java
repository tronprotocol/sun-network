...
public class ContractTrcToken067 {
  ...
  public void test01DeployTransferTokenContract() {
    ...
    Assert.assertTrue(PublicMethedForDailybuild.sendcoin(user001Address, 4048_000_000L, fromAddress,
        testKey002, blockingStubFull));
  ...
  public void test02DeployRevContract() {
    ...
    String recieveTokenTxid = PublicMethedForDailybuild
  ...
  public void test03TriggerContract() {
    ...
    logger.info(
        "the value: " + PublicMethedForDailybuild.getStrings(transactionInfo.getLogList().get(0).getData()
            .toByteArray()));

    List<String> retList = PublicMethedForDailybuild.getStrings(transactionInfo.getLogList().get(0)
        .getData().toByteArray());
  ...
  public void test04TriggerTokenBalanceContract() {
    Assert.assertTrue(PublicMethedForDailybuild.freezeBalanceGetEnergy(user001Address, 1000_000_000L,
    ...
    PublicMethedForDailybuild.waitProduceNextBlock(blockingStubFull);
    Optional<TransactionInfo> infoById = PublicMethedForDailybuild.getTransactionInfoById(triggerTxid,
        blockingStubFull);
    logger.info("Trigger energytotal is " + infoById.get().getReceipt().getEnergyUsageTotal());
    ...
    Long assetIssueCount = PublicMethedForDailybuild.getAssetIssueValue(resultContractAddress, assetAccountId,
        blockingStubFull);
