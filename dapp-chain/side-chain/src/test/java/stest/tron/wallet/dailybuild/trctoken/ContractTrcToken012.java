...
public class ContractTrcToken012 {
  ...
  public void test01DeployTransferTokenContract() {
    ...
    Assert.assertTrue(PublicMethedForDailybuild.sendcoin(user001Address, 14048_000_000L, fromAddress,
        testKey002, blockingStubFull));
    ...
    String filePath = "./src/test/resources/soliditycode/contractTrcToken012.sol";
  ...
  public void test02TriggerContract() {
    ...
    Long receiveAssetBefore = PublicMethedForDailybuild.getAssetIssueValue(dev001Address, assetAccountId,
        blockingStubFull);
    ...
    Long receiveAssetAfter = PublicMethedForDailybuild.getAssetIssueValue(dev001Address,
        assetAccountId, blockingStubFull);
