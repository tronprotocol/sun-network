...
public class ContractTrcToken030 {
  ...
  public void deploy02TransferTokenContract() {
    ...
    final Long beforeUserBalance = PublicMethedForDailybuild.queryAccount(user001Address, blockingStubFull)
        .getBalance();
    ...
    Long afterBalanceContractAddress = PublicMethedForDailybuild.queryAccount(transferTokenContractAddress,
        blockingStubFull).getBalance();
    final Long afterUserBalance = PublicMethedForDailybuild.queryAccount(user001Address, blockingStubFull)
        .getBalance();
