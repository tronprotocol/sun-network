...
public class Create2Test004 {
  ...
  public void test02TriggerCreate2ToDeployFactory2Contract() {
    Assert.assertTrue(PublicMethedForDailybuild.freezeBalanceForReceiver(fromAddress,
        PublicMethedForDailybuild.getFreezeBalanceCount(user001Address, user001Key, 150000L,
            blockingStubFull), 0, 1,
  ...
  public void test03TriggerCreate2ToDeployTestContract() {
    Assert.assertTrue(PublicMethedForDailybuild.freezeBalanceForReceiver(fromAddress,
        PublicMethedForDailybuild.getFreezeBalanceCount(user001Address, user001Key, 80000L,
            blockingStubFull), 0, 1,
        ByteString.copyFrom(user001Address), testKey002, blockingStubFull));
  ...
  public void test04TriggerCreate2ToDeployTestContract2() {
    ...
    final String triggerTxid = PublicMethedForDailybuild.triggerContract(factoryContractAddress2,
        "deploy(bytes,uint256)", param, false, callValue,
        1000000000L, "0", 0, user001Address, user001Key,
        blockingStubFull);
    PublicMethedForDailybuild.waitProduceNextBlock(blockingStubFull);
