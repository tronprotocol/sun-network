...
public class Create2Test018 {
  ...
  public void test01DeployFactoryContract() {
    ...
    Assert
        .assertTrue(PublicMethedForDailybuild.sendcoin(witnessAddress001, 100_000_000L, fromAddress,
            testKey002, blockingStubFull));
  ...
  public void test02TriggerCreate2ToDeployTestContract() {
    Assert.assertTrue(
        PublicMethedForDailybuild.freezeBalanceForReceiver(fromAddress, 9000_000_000_000L, 0, 1,
    ...
    accountResource = PublicMethedForDailybuild
        .getAccountResource(witnessAddress001, blockingStubFull);
    ...
    long userBalanceBefore = PublicMethedForDailybuild
        .queryAccount(witnessAddress001, blockingStubFull)
        .getBalance();
    ...
    long userBalanceAfter = PublicMethedForDailybuild
        .queryAccount(witnessAddress001, blockingStubFull)
        .getBalance();
