...
public class ContractScenario014 {
  ...
  public void testTripleTrigger() {
    ...
    Assert.assertTrue(
        PublicMethedForDailybuild.sendcoin(contract014Address, 50_000_000_000L, fromAddress,
    ...
    HashMap retMap1 = PublicMethedForDailybuild.getBycodeAbi(filePath1, contractName);

    String code1 = retMap1.get("byteCode").toString();
    String abi1 = retMap1.get("abI").toString();
    String parame = "\"" + Base58.encode58Check(contractAddress1) + "\"";

    txid = PublicMethedForDailybuild.deployContractWithConstantParame(contractName, abi1, code1,
    ...
    HashMap retMap2 = PublicMethedForDailybuild.getBycodeAbi(filePath2, contractName);
    ...
    txid = PublicMethedForDailybuild.deployContractWithConstantParame(contractName, abi2, code2,
        "constructor(address)", parame, "", maxFeeLimit, 1000000L, 100, null,
        contract014Key, contract014Address, blockingStubFull);
    PublicMethedForDailybuild.waitProduceNextBlock(blockingStubFull);
    infoById = PublicMethedForDailybuild.getTransactionInfoById(txid, blockingStubFull);
  ...
  public void shutdown() throws InterruptedException {
    PublicMethedForDailybuild
        .unFreezeBalance(contract014Address, contract014Key, 1, contract014Address,
            blockingStubFull);
    PublicMethedForDailybuild
