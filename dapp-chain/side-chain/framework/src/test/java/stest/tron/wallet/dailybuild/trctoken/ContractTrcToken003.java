...
public class ContractTrcToken003 {
  ...
  private final byte[] tokenOnwerAddress2 = PublicMethed
  ...
  public void beforeClass() {
    ...
    Assert.assertTrue(
            PublicMethed.transferAsset(dev001Address, assetAccountDev.toByteArray(),
    ...
    Assert.assertTrue(
            PublicMethed.transferAsset(user001Address, assetAccountUser.toByteArray(),
