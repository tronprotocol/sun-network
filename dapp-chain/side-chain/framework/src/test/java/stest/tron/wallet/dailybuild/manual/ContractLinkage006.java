...
public class ContractLinkage006 {
  ...
  public void teststackOutByContract() {
    ...
    Assert
        .assertTrue(PublicMethedForDailybuild.sendcoin(linkage006Address, 20000000000L, fromAddress,
    ...
    Account infoafter = PublicMethedForDailybuild
        .queryAccount(linkage006Address, blockingStubFull1);
  ...
  public void teststackOutByContract1() {
    Assert.assertTrue(
        PublicMethedForDailybuild.sendcoin(linkage006Address2, 20000000000L, fromAddress,
            testKey003, blockingStubFull));
    PublicMethedForDailybuild.waitProduceNextBlock(blockingStubFull);
    ...
    Account infoafter1 = PublicMethedForDailybuild
        .queryAccount(linkage006Address2, blockingStubFull1);
  ...
  public void shutdown() throws InterruptedException {
    PublicMethedForDailybuild.unFreezeBalance(linkage006Address, linkage006Key, 1,
        linkage006Address, blockingStubFull);
    PublicMethedForDailybuild.unFreezeBalance(linkage006Address, linkage006Key, 0,
        linkage006Address, blockingStubFull);
    PublicMethedForDailybuild.unFreezeBalance(linkage006Address2, linkage006Key2, 1,
        linkage006Address2, blockingStubFull);
    PublicMethedForDailybuild.unFreezeBalance(linkage006Address2, linkage006Key2, 0,
        linkage006Address2, blockingStubFull);
    PublicMethedForDailybuild
        .freedResource(linkage006Address, linkage006Key, fromAddress, blockingStubFull);
    PublicMethedForDailybuild
        .freedResource(linkage006Address2, linkage006Key2, fromAddress, blockingStubFull);
    if (channelFull != null) {
