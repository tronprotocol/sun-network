...
class RpcClient {
  ...
  TransactionExtention deployContract(Contract.CreateSmartContract request) {
    return blockingStub.deployContract(request);
  }

  TransactionExtention createAccount(Contract.AccountCreateContract request) {
    return blockingStub.createAccount2(request);
  }
