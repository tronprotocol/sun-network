...
public class App {
  ...
  public static void main(String[] args) {
    ...
    ChainTask mainChainTask = new ChainTask(TaskEnum.MAIN_CHAIN, mainGatewayAccount,
        mainGatewayAddress, fixedThreads);
    ChainTask sideChainTask = new ChainTask(TaskEnum.SIDE_CHAIN, sideChainGatewayAccount,
