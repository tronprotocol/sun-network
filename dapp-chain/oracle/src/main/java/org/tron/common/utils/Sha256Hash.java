...
public class Sha256Hash implements Serializable, Comparable<Sha256Hash> {
    ...
    /**
     * Creates a new instance containing the calculated (one-time) hash of the given file's
     * contents. The file contents are read fully into memory, so this method should only be used
     * with small files.
     *
     ...
     * suitable hash code even for blocks, where the goal is to try and get the first bytes to be
     * zeros (i.e. the value as a big integer lower than the target value).
     */
    @Override
    public int hashCode() {
