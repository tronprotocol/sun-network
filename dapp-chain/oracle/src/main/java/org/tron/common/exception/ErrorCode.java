...
public enum ErrorCode {
  ...
  CHECK_TRANSACTION_FAIL(2,
      "tx: %s, fail, please resolve this problem by reviewing and inspecting logs of oracle, error msg: %s");
  private int code;
  private String msg;
  ...
  public static String getCheckTransactionFail(String txId, String msg) {
