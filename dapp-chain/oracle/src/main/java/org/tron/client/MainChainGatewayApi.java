...
public class MainChainGatewayApi {
  ...
  public static String withdrawTRC20(String to, String mainChainAddress, String value, String txData)
    throws RpcException {
    byte[] contractAddress = Args.getInstance().getMainchainGateway();
  ...
  public static String withdrawTRC721(String to, String mainChainAddress, String value, String txData)
    throws RpcException {
    byte[] contractAddress = Args.getInstance().getMainchainGateway();
