...
public class ConfigInfo {
  ...
  public static final String privateKeyAddressFile = config.getString("sidechain.private.key.address.file");
  ...
  public static final Long accountFreezeBalance = config.getLong("sidechain.account.freeze.balance");
  ...
  public static final Long contractDepositValue = config.getLong("sidechain.contract.deposit.value");

  public static final String contractWithdraw = config.getString("sidechain.contract.withdraw.func");
