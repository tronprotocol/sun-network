...
describe('SunWeb Instance', function() {
    ...
    describe('#depositTrc20', function () {
        ...
        it('deposit trc20 from main chain to side chain', async function () {
            ...
            const mBeforeBalance = await m20Contract.balanceOf(ACCOUNTADDRESS).call();
            ...
            indobyid1before=await sunWeb.sidechain.transactionBuilder.triggerSmartContract(ADDRESS20_MAPPING, 'balanceOf(address)'
                , {feeLimit: FEE_LIMIT}, [{type: 'address', value: ACCOUNTADDRESS}]);
            ...
            const txid = sunWeb.approveTrc20(200000, 10000000, CONTRACT_ADDRESS20)
            ...
            const mdeposittrc20after = await mdeposittrc20afterinfo.balanceOf(ACCOUNTADDRESS).call();
